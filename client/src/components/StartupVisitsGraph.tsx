      ...
      {visitData.length ? (
        <>
          <div className="flex justify-between items-center mb-4">
            ...
            >
              <div
                className={`absolute right-0 top-0 h-full w-1/2 bg-blue-600 rounded-full transition-transform duration-300 ease-in-out ${
                  view === "monthly" ? "-translate-x-full" : "translate-x-0"
                }`}
              />
